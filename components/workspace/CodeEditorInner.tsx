...
import { BASE_DEPENDENCIES } from "./CodeEditor";
...
<html lang="en">
  <head>
    ...
    <title>CodeSphere Vue App</title>
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>CodeSphere Svelte App</title>
    <script src="https://cdn.tailwindcss.com"></script>
  </head>
  <body class="bg-[#0a0a0a] text-white">
    <div id="app"></div>
    <script type="module" src="/src/main.js"></script>
        ...
        for (const [filePath, fileObj] of Object.entries(filesToZip)) {
          ...
          const zipPath = cleanPath.startsWith("src/") ? cleanPath : `src/${cleanPath}`;
          zip.file(zipPath, code);
        }
...
root.render(<React.StrictMode><App /></React.StrictMode>);`
      ...
      zip.file(
        "README.md",
        `# CodeSphere App\n\nGenerated with [CodeSphere AI](https://codesphere.app).\n\n## Getting started\n\n\`\`\`bash\nnpm install\nnpm run dev # or npm start for React\n\`\`\``
      );
