  ...
  return (
    <div className="flex w-[320px] shrink-0 flex-col bg-[#0d0d0d]">
      ...
      <div className="flex items-center justify-between border-b border-white/6 px-2 py-3">
        ...
        <PricingDialog reason={noCredits ? "credits" : "upgrade"}>
          <button
            type="button"
            className={cn(
      ...
      {noCredits && (
        <div className="mx-3 mb-2 rounded-xl border border-red-500/15 bg-red-950/40 px-4 py-3">
          ...
          <PricingDialog reason="credits">
            <button
              type="button"
              className="inline-flex h-8 items-center gap-1.5 rounded-full text-xs active:scale-95 cursor-pointer bg-white text-black px-3"
            >
