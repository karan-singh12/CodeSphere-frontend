...
export const FEATURES = [
  {
    ...
    desc: "Describe your app in plain English. Gemini 3.5 Flash returns production-ready React, Vue, Svelte, or HTML/JS code in seconds.",
  },
  {
    icon: Eye,
    label: "Live preview",
...
export const STEPS = [
  ...
  },
  {
    ...
    desc: "Gemini writes React, Vue, Svelte, or Static HTML/JS code, picks dependencies, and structures your files.",
  },
  {
    number: "03",
